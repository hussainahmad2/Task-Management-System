...
export const LeaveGroup: React.FC<LeaveGroupProps> = ({
  groupName,
  onConfirm,
  onCancel,
}) => {
        ...
        <div className="p-6">
          ...
          <div className="mb-6">
            <p className="text-gray-600 dark:text-gray-300">
              Are you sure you want to leave the group <span className="font-semibold text-gray-900 dark:text-white">"{groupName}"</span>? 
              You won't be able to send or receive messages in this group.
            </p>
          </div>
